...
import { 
    Card, Heading, CardBody, Text, Button, 
...
import CardHeaderBar from './CardHeaderBar/CardHeaderBar'
...
const BoothCard = (props) => {
    ...
    return (
        ...
        <CardButton bg={variant==="gray"?bg:variant} 
            ...
            <CardHeaderBar variant={variant} data={data}/>
            <ButtonBar currentIndex={currentIndex} setCurrentIndex={setCurrentIndex}/>
            <CardContent currentIndex={currentIndex} data={data}/>
